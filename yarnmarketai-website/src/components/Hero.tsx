    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-5xl mx-auto text-center animate-fade-in-up">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 mt-4 rounded-full bg-gradient-card border border-border mb-8">
            <MessageSquare size={16} className="text-primary" />
            <span className="text-sm font-medium">
              AI-Powered Fast Customer Engagement Platform
            </span>
          </div>
          ...
          <p className="text-xl text-muted-foreground mb-12 max-w-3xl mx-auto leading-relaxed">
            Connect with customers in any language, automate support 24/7, and
            boost sales with our intelligent Multilingual conversation engine.
            One platform for WhatsApp, Instagram, Facebook Messenger, and your
            website automated real-time chat app.
          </p>
