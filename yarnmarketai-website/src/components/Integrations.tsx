...
const integrations = [
  {
    ...
    description:
      "Connect your WhatsApp Business account and manage all conversations in one place",
  },
  {
    icon: Instagram,
    name: "Instagram",
  ...
  },
  {
    ...
    name: "Shopify",
    description:
      "Sync products, orders, and customer data directly from your Shopify store",
  },
  {
    icon: Package,
    name: "WooCommerce",
    description:
      "Connect your WooCommerce store and automate order updates and support",
  },
  {
    icon: CreditCard,
    name: "Stripe",
    description:
      "Process payments and manage transactions directly in chat conversations",
  },
];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground">
            Works with all the tools you already use. Set up in minutes, not
            hours.
          </p>
        </div>
